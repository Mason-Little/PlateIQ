...
import { deleteSession, fetchSessionByDate, fetchSessions, updateSession } from "@/api/sessions";
...
export const useUpdateSession = () => {
  ...
  return useMutation({
    mutationFn: ({ sessionId, updates }: { sessionId: string; updates: { name: string } }) =>
